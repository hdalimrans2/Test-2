...
handle_password() {
    ...
    while true; do
        clear
        echo -e "${b}╭═══════════════════════════════════════════════╮${n}"
        echo -e "${b}║             ${c}Welcome to NX SIVER LAB             ${b}║${n}"
        echo -e "${b}╰═══════════════════════════════════════════════╯${n}"
        echo
        ...
        if [ "$user_pass" == "$correct_pass" ]; then
            ...
            xdg-open "https://youtube.com/@hdshortvideo69"
            sleep 3
            break
        else
...
main_banner() {
    ...
    echo -e "   ${c}╚═╝░░╚══╝╚═╝░░╚═╝"
    echo -e "${y}   +-+-+-+-+-+-+-+-+-+-+-+-+-+-+"
    echo -e "${c}   |N|X| |S|I|V|E|R| |L|A|B|"
    echo -e "${y}   +-+-+-+-+-+-+-+-+-+-+-+-+-+-+${n}"
    echo
    echo -e "${b}╭══ ${g}〄 ${y}NX SIVER LAB ${g}〄"
...
show_banner() {
    ...
    local tool_info="[Σ] NX SIVER LAB"
    ...
    tput cup 11 0
    echo -e " \${welcome_color}Welcome to NX SIVER LAB, '\${name_color}\${BANNER_TEXT}\${welcome_color}'!${nc}"
    echo
...
EOF
    ...
    cat <<EOF > "$HOME/.oh-my-zsh/custom/themes/nxsiverlab.zsh-theme"
# NX SIVER LAB Custom Theme (Second line of prompt)
